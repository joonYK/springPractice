...
public class UserDaoTest {
    ...
    @Before
    public void setUp() {
        user1 = new User("gyumee", "박성철", "springno1", Level.BASIC, 1, 0, "aaa@asd.com");
        user2 = new User("leegw700", "이길원", "springno2", Level.SILVER, 5, 10, "bbb@bbb.com");
        user3 = new User("bumjin", "박범진", "springno3", Level.GOLD, 100, 100, "shutingz@naver.com");
    }
